    ...
    return (
        <div className = "projects">
            ...
            <div className = "projectText">
                ...
                <br/><h3>Street Tournament registration website that connects players and coaches nationwide.</h3>
                <ul>
            ...
            <div className = "projectText">
                ...
                <br/><h3>Book review website that fosters conversations between readers and authors.</h3>
                <ul>
            ...
            <div className = "projectText">
                ...
                <br/><h3>Basketball player rating application that allows users to vote on who they feel are the top players in the NBA.</h3>
                <ul>
                <li>Utilizes Ruby on Rails as a backend API.</li>
